...
SECRET_KEY = 'django-insecure-y&4m648=q-6by0&v3++e(yo^2l5ul#tk851d&&&q8$_kd%s!-w'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # Keep CORS middleware early
...
ROOT_URLCONF = 'Nearnest_backend.urls'
...
WSGI_APPLICATION = 'Nearnest_backend.wsgi.application'
